...
SYSTEM_PROMPT = "You are a helpful assistant, analysing the properties of news articles. Before a final answer, make sure to explain your thinking."
...
To respond, please list the emotions present in the article. When labelling the article for the 'Neutral' emotion, please make sure no other emotion is present.
The article's title and body are provided. After you provide your reasoning, respond with a list of {{joy, sadness, trust, disgust, fear, anger, surprise, anticipation, neutral}}, and nothing else.
"""
