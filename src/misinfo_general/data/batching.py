...
def eval_collator(features: typing.List[typing.Dict]) -> typing.Dict[str, typing.Any]:
    batch = dict()
    ...
    batch["labels"] = list(map(itemgetter("label"), features))

    batch["article_ids"] = list(map(itemgetter("article_id"), features))
