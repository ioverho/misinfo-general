...
from misinfo_benchmark_models.splitting import limited_publisher_split_dataset
...
def test(args: DictConfig):
    ...
    dataset = limited_publisher_split_dataset(
        dataset=dataset,
    ...
    preds_file_name = f"preds_generalisation[limited_publisher]_year[{args.year}]_use_political_bias[{args.split.use_political_bias}]_num_sources[{args.split.num_sources}]_split[{args.split.split_name}].csv"
